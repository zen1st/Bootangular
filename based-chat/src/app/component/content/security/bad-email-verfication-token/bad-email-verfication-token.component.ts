...
@Component({
  selector: 'app-bad-email-verfication-token',
  templateUrl: './bad-email-verfication-token.component.html',
  styleUrls: ['./bad-email-verfication-token.component.css']
})
export class BadEmailVerficationTokenComponent implements OnInit {

...
import {UserAddDialogComponent} from 'app/component/dialogs/user/add/user.add.dialog.component';
import {UserEditDialogComponent} from 'app/component/dialogs/user/edit/user.edit.dialog.component';
import {UserDeleteDialogComponent} from 'app/component/dialogs/user/delete/user.delete.dialog.component';
